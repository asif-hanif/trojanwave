...
class AudioEncoder(nn.Module):
    def __init__(self, audioenc_name:str, d_in: int, d_out: int, sample_rate: int, window_size: int,
        ...
        # instantiates the HTSTAT wrapper
        # modify base in the definition so it takes a noise parameter as well 
    ...
    def forward(self, x, noise, backdoor_tag):
        out_dict = self.base(x, noise, backdoor_tag)
